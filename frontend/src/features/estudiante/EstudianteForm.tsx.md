...
- const [apellido1, setApellido1]
- const [apellido2, setApellido2]
- const [sexo, setSexo]
- const [genero, setGenero]
- const [edad, setEdad]
- const [telefono, setTelefono]
- const [email, setEmail]
- const [email2, setEmail2]
- const [nacionalidad, setNacionalidad]
- const [pueblo, setPueblo]
- const [pais, setPais]
- const [paisOtro, setPaisOtro]
- const [region, setRegion]
- const [comuna, setComuna]
- const [institucion, setInstitucion]
- const [cuidador, setCuidador]
- const [sexoOpts, setSexoOpts]
- const [generoOpts, setGeneroOpts]
- const [edadOpts, setEdadOpts]
- const [pueblosOpts, setPueblosOpts]
- const [paisOpts, setPaisOpts]
- const [regionOpts, setRegionOpts]
- const [comunaOpts, setComunaOpts]
...
- `formatRut`: componente o función exportada.
- `validateRut`: componente o función exportada.
- `handleRutBlur`: componente o función exportada.
- `fetchCuidador`: componente o función exportada.
- `validateAll`: componente o función exportada.
- `handleSubmit`: componente o función exportada.
- `getClientIp`: componente o función exportada.
- `getClientInfoSync`: componente o función exportada.

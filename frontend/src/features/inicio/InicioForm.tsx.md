...
- Puntos clave encontrados en el cuerpo:
  ...
  - Utiliza `navigate()` para cambiar de ruta tras acciones (p. ej. envío de formulario).
  - Llama a `crearSolicitud` para crear recursos en el backend y recibir `solicitudid`.
